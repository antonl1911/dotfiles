...
muc_nick = "-~>"
naughty.config.icon_dirs = { "/usr/share/gajim/data/iconsets/gota/32x32/",  }
...
--local fanwidget  = wibox.widget.textbox()
--vicious.register(thermalwidget, vicious.widgets.thermal, " CPU - $1°C", 1, { "it87.656", "core"} )
--vicious.register(fanwidget, vicious.widgets.thermal, "::$1 RPM", 1, { "it87.656", "fan1" } )
-- }}}
...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey, "Shift"	  }, "m", function () awful.util.spawn_with_shell(string.format("~/bin/youtube.sh")) end),
...
-- 	awful.key({ "XF86AudioLowerVolume"		 	  }, function () awful.util.spawn(string.format("mpc -h %s volume -10", myhost)) end),
    ...
    awful.key({ modkey,  		  }, "F12", function () awful.util.spawn_with_shell("xset dpms force standby") end),
...
clientkeys = awful.util.table.join(
	...
	awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer set SoftMaster 2+") end),
	awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer set SoftMaster 2-") end)
)
